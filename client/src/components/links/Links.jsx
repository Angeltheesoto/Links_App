...
const Links = ({
  ...
  return (
    <div className="linksContainer linksGrow" key={uniKey}>
      <a href={url} className="linksLink" target="_blank">
        <div className="linksContent">
          <div className="linksBrand">
            {brand === "facebook" ? (
      ...
      <div className="linksBtnContainer linksGrow">
        {edit ? (
          <button onClick={editevent} className="linksEdit">
            {/* {edit} */}
            <EditIcon />
          </button>
        ) : null}
        {del ? (
          <button onClick={deleteevent} className="linksDel">
            {/* {del} */}
            <DeleteForeverIcon />
          </button>
        ) : null}
